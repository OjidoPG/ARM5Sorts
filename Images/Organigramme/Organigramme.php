                    ...
                    <div class="col-md-12">
                        <div class="collapse" id="mariecarmin">
                            <div class="card card-body">
                                ...
                                <div class="row justify-content-center"><strong>Fonction :</strong>&nbsp;Cuisinière et
                                    nourrice d'Iris
                                </div>
                                <div class="row justify-content-center"><strong>Note :</strong>&nbsp;Lien affectif fort
                                    avec Iris
                                </div>
                                <div class="row justify-content-center"><strong>Personnalité :</strong>&nbsp;Expressive,
                                    bruyante, franche
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="collapse" id="hugues">
                            <div class="card card-body">
                                ...
                                <div class="row justify-content-center"><strong>Personnalité :</strong>&nbsp;Discret,
                                    passioné, distant
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="collapse" id="arthur">
                            <div class="card card-body">
                                ...
                                <div class="row justify-content-center"><strong>Personnalité :</strong>&nbsp;Jovial,
                                    bruyant, épicurien
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-3 text-center">
                    ...
                    <div class="col-md-12">
                        <div class="collapse" id="jehane">
                            <div class="card card-body">
                                <div class="row justify-content-center"><strong>PNJ</strong>&nbsp</div>
                                <div class="row justify-content-center"><strong>Fonction :</strong>&nbsp;Professeur des
                                    écoles
                                </div>
                                <div class="row justify-content-center"><strong>Personnalité :</strong>&nbsp;Autoritaire,
                                    caractérielle, déterminée
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-3 text-center">
                    ...
                    <div class="col-md-12">
                        <div class="collapse" id="evelynemassart">
                            <div class="card card-body">
                                <div class="row justify-content-center"><strong>PNJ</strong>&nbsp</div>
                                <div class="row justify-content-center"><strong>Fonction :</strong>&nbsp;Gestion
                                    entrepôt nourriture
                                </div>
                                <div class="row justify-content-center"><strong>Personnalité :</strong>&nbsp;Discrète,
                                    renfermée, timide
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-3 text-center">
                    ...
                    <div class="col-md-12">
                        <div class="collapse" id="isoldepontanier">
                            <div class="card card-body">
                                <div class="row justify-content-center"><strong>PNJ</strong>&nbsp</div>
                                <div class="row justify-content-center"><strong>Fonction :</strong>&nbsp;Tenancière
                                    salle commune
                                </div>
                                <div class="row justify-content-center"><strong>Personnalité :</strong>&nbsp;Affirmée,
                                    têtue, courageuse
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-3 text-center">
                    ...
                    <div class="col-md-12">
                        <div class="collapse" id="aloisferack">
                            <div class="card card-body">
                                <div class="row justify-content-center"><strong>PNJ</strong>&nbsp</div>
                                <div class="row justify-content-center"><strong>Fonction :</strong>&nbsp;Gestion dépôt
                                    arme
                                </div>
                                <div class="row justify-content-center"><strong>Personnalité :</strong>&nbsp;Rigoureux,
                                    bagarreur, têtu
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="collapse" id="fulbertmassin">
                            <div class="card card-body">
                                ...
                                <div class="row justify-content-center"><strong>Personnalité :</strong>&nbsp;Epicurien,
                                    bruyant, bagarreur
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-3 text-center">
                    ...
                    <div class="col-md-12">
                        <div class="collapse" id="michel">
                            <div class="card card-body">
                                <div class="row justify-content-center"><strong>PNJ</strong>&nbsp</div>
                                <div class="row justify-content-center"><strong>Fonction :</strong>&nbsp;Prêtre de
                                    Javielle
                                </div>
                                <div class="row justify-content-center"><strong>Personnalité :</strong>&nbsp;Sociable,
                                    altruiste, fiable
                                </div>
                            </div>
                        </div>
